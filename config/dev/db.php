...
$config = [
    'components' => [
        'db' => [
            ...
            'charset' => 'utf8',
            'dsn' => 'mysql:host=172.22.131.242:3306;dbname=julive_system',
        ...
        'db_yingyan' => [
            'class' => 'yii\db\Connection',
            'charset' => 'utf8',
            'dsn' => 'mysql:host=172.22.131.242:3306;dbname=track',
        ...
        'db_pc_comjia' => [
            'class' => 'yii\db\Connection',
            'charset' => 'utf8',
            'dsn' => 'mysql:host=172.22.131.242:3306;dbname=comjia_merge',
            'username' => 'comjia002_wukong',
            'password' => 'Je6Quo!jei-ph9Esfo$iFee2',
            'enableSchemaCache' => false,
            'schemaCacheDuration' => 86400,//缓存一天
